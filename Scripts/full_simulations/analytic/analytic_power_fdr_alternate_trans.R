...
combined <- combined[cis_flag == FALSE]
...
analytic_power_fdr %>%
  melt(measure.vars = c("power_filtered_fdr", "power_all_fdr", "power_all_alt_fdr", "power_all_alt2_fdr", "power_all_alt3_fdr", "power_all_alt4_fdr", "power_all_same_fdr")) %>%
...
analytic_power_fdr[, es_bin_labelled := sprintf("beta*': %s'", es_bin)]

analytic_power_fdr[qtl_tag == TRUE] %>%
subset(es_bin != "< 0.025") %>%
  melt(
    measure.vars = c("power_filtered_fdr", "power_all_same_fdr", "power_all_fdr", "power_all_alt_fdr", "power_all_alt2_fdr", "power_all_alt3_fdr", "power_all_alt4_fdr"),
...
ggsave("Plots/power_comparisons/power_filtered_alt_dist.pdf", width = 7.75, height = 6.25)
